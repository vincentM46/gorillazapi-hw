...
const main = async () => {
    const albums = [
        ...
        { name: 'The Now Now', image: 'https://upload.wikimedia.org/wikipedia/en/7/79/Gorillaz_-_The_Now_Now.jpg', track_count: '11', release_date: 'June 29 2018', album_length: "40:42" },
